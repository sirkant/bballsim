...
class Player:
    def __init__(self, player_data):
        ...
        self.ratings = {}
        for key in ['id', 'pos', 'hgt', 'weight', 'born_year', 'born_loc', 'imgURL', 'college', 'injury_type', 'injury_games_remaining', 'tid']:
    ...
    def display_player_info(self):
        ...
        print(f"Stats: Points: {self.stats['points']}, Rebounds: {self.stats['rebounds']}, Assists: {self.stats['assists']}")
